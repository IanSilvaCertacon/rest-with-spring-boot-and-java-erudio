...
import br.com.certacon.restful_api_java_obj_list.exceptions.RequiredObjectIsNullException;
import br.com.certacon.restful_api_java_obj_list.mapper.MockBook;
...
class BookServicesTest {
    ...
    void testFindAll() {
        ...
        assertEquals("Some Author1", bookFour.getAuthor());
        assertEquals("Some Title1", bookFour.getTitle());
        ...
        assertEquals("Some Author1", bookSeven.getAuthor());
        assertEquals("Some Title1", bookSeven.getTitle());
